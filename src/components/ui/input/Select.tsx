...
export const Select: React.FC<SelectProps> = ({
  ...
  // Check for autofill
  useEffect(() => {
    if (selectRef.current && selectRef.current.value && !internalValue) {
      const autofillValue = selectRef.current.value;
      setInternalValue(autofillValue);
      if (onChange) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      <div className={containerClassName} onClick={handleClick}>
        {/* Hidden native select element for autofill capabilities */}
        <select
          ref={selectRef}
          name={name}
          id={id}
