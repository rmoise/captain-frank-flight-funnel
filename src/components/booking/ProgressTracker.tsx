...
export const ProgressTracker: React.FC<ProgressTrackerProps> = ({
  ...
  const wizardAnswers = useAppSelector((state) => state.user.wizardAnswers);
  const personalDetails = useAppSelector((state) => state.user.personalDetails);
  const currentStep = useAppSelector((state) => state.progress.currentPhase);
  ...
  const handleStepClick = useCallback(
    (stepId: number) => {
      ...
      dispatch(setCurrentPhase(stepId));
