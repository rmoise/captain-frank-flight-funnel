...
export const FlightSelector: React.FC<FlightSelectorProps> = ({
  ...
  const handleMultiFlightDelete = useCallback(
    async (index: number, e?: React.MouseEvent) => {
      ...
      // Create new segments array without the deleted segment
      const newSegments = flightSegments.filter((_, i) => i !== index);
      ...
      if (remainingFlights.length > 0) {
        ...
        // If no flights remain, clear everything but don't mark steps as incomplete in phase 3
        dispatch(setSelectedFlights([]));
        if (currentPhase !== 3) {
          dispatch(markStepIncomplete(3));
          dispatch(markStepIncomplete(1));
        ...
        // Switch back to direct flight mode if no segments remain
                  ...
                  {showFlightSearch && currentPhase !== 1 && (
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <button
                        ...
                        className="h-14 px-6 text-white bg-[#F54538] rounded-xl hover:bg-[#F54538]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F54538] disabled:opacity-50 font-['Heebo'] font-medium text-base"
                      >
                        Search Flights
                      </button>
                    </div>
              ...
              <>
                ...
                <div className="flex flex-col gap-4">
                  <button
                    ...
                    className="w-full h-12 px-4 py-2 text-white bg-[#F54538] rounded-xl hover:bg-[#F54538]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F54538] disabled:opacity-50 font-['Heebo'] font-medium text-base"
                  >
                    Search Flights
                  </button>
                  {errorMessage && (
                      ...
                      {filteredFlights.map((flight) => (
                        <button
                          ...
                          className={`w-full text-left transition-all ${
                            view === 'list'
                              ? 'px-4 py-3 hover:bg-gray-50 border-b border-gray-200 last:border-b-0'
                              : 'p-4 bg-white border border-gray-200 rounded-lg hover:border-[#F54538] hover:shadow-lg'
                          }`}
                        >
                          {view === 'list' ? (
