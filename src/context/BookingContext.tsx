  ...
  switch (action.type) {
    ...
    case 'SET_EXPERIENCE':
      return {
        ...
        completedSteps: [...state.completedSteps, 2].filter((v, i, a) => a.indexOf(v) === i),
    ...
    case 'SET_PASSENGER_DETAILS':
      return {
        ...
        completedSteps: [...state.completedSteps, 3].filter((v, i, a) => a.indexOf(v) === i),
    ...
    case 'SKIP_STEP':
      return {
        ...state,
        skippedSteps: [...state.skippedSteps, action.payload].filter((v, i, a) => a.indexOf(v) === i),
        completedSteps: state.completedSteps.filter(step => step !== action.payload)
      };
