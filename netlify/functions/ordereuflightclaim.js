...
const handler = async (event) => {
    ...
    try {
        ...
        const apiRequestBody = {
            ...
            arbeitsrecht_marketing_status: requestBody.arbeitsrecht_marketing_status,
        ...
        console.log('Journey Fact Type:', requestBody.journey_fact_type, '(must be one of:', validJourneyFactTypes.join(', '), ')');
        console.log('Information Received At:', requestBody.information_received_at);
